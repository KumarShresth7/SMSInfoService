...
const Hero = () => {
  ...
  return (
    <section id="home" className="hero-section bg-gradient-to-r from-indigo-400 to-indigo-600 h-screen flex flex-col lg:flex-row items-center justify-center px-6 lg:px-16 text-white">
